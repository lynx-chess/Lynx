...
public class ViriformatFilterTest
{
    ...
    public void MinPieces_FiltersWhenTooFew()
    {
        ...
        var mv = MoveExtensions.Encode((int)BoardSquare.a1, (int)BoardSquare.a2);
    ...
    public void MaxEval_FiltersWhenEvalTooLarge()
    {
        ...
        var mv = MoveExtensions.Encode((int)BoardSquare.e2, (int)BoardSquare.e4);
        var rng = new Random(1);
    ...
    public void FilterTactical_CaptureAndPromotion_AreFiltered()
    {
        ...
        var cap = MoveExtensions.Encode((int)BoardSquare.e2, (int)BoardSquare.e7);
        Assert.IsTrue(filter.ShouldDrop(cap, 0, position, 1, 0, rng));

        // promotion (promoted piece set)
        var promo = MoveExtensions.EncodePromotion((int)BoardSquare.a7, (int)BoardSquare.a8, (int)Piece.N);
    ...
    public void FilterCastling_FiltersCastleMoves()
    {
        ...
        var castle = MoveExtensions.EncodeCastle(Constants.InitialWhiteKingSquare, Constants.WhiteKingShortCastleSquare);
