...
namespace Lynx.Test
{
    ...
    public class PerftTest
    {
        ...
        [TestCase(Constants.InitialPositionFEN, 7, 3_195_901_860, Category = "ExtraExtraLongRunning", Explicit = true)]
        [TestCase(Constants.InitialPositionFEN, 8, 84_998_978_956, Category = "ExtraExtraLongRunning", Explicit = true)]
        [TestCase(Constants.InitialPositionFEN, 9, 2_439_530_234_167, Category = "ExtraExtraLongRunning", Explicit = true)]
        ...
        [TestCase("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", 6, 8_031_647_685, Category = "ExtraExtraLongRunning", Explicit = true)]
        ...
        [TestCase("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 8, 3_009_794_393, Category = "ExtraExtraLongRunning", Explicit = true)]
        ...
        [TestCase("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1", 6, 706_045_033, Category = "ExtraExtraLongRunning", Explicit = true)]
        ...
        [TestCase("r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1", 6, 706_045_033, Category = "ExtraExtraLongRunning", Explicit = true)]
        ...
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 6, 6_923_051_137, Category = "ExtraExtraLongRunning", Explicit = true)]
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 7, 287_188_994_746, Category = "ExtraExtraLongRunning", Explicit = true)]
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 8, 11_923_589_843_526, Category = "ExtraExtraLongRunning", Explicit = true)]
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 9, 490_154_852_788_714, Category = "ExtraExtraLongRunning", Explicit = true)]
