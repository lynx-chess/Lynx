...
public class TranspositionTableTests
{
    ...
    public void RecordHash_ProbeHash(int recordedEval, NodeType recordNodeType, int probeAlpha, int probeBeta, int expectedProbeEval)
    {
        ...
        transpositionTable.RecordHash(mask, position, depth: 5, ply: 3, rawScore: recordedEval, nodeType: recordNodeType, move: 1234);
    ...
    public void RecordHash_ProbeHash_CheckmateSameDepth(int recordedEval)
    {
        ...
        transpositionTable.RecordHash(mask, position, depth: 10, ply: sharedDepth, rawScore: recordedEval, nodeType: NodeType.Exact, move: 1234);
    ...
    public void RecordHash_ProbeHash_CheckmateDifferentDepth(int recordedEval, int recordedDeph, int probeDepth, int expectedProbeEval)
    {
        ...
        transpositionTable.RecordHash(mask, position, depth: 10, ply: recordedDeph, rawScore: recordedEval, nodeType: NodeType.Exact, move: 1234);
