...
public class PositionTest
{
    ...
    public void ScaleEvalWith50MovesDrawDistance()
    {
        ...
        Assert.Greater(position.StaticEvaluation(), position.StaticEvaluation());
        Assert.AreEqual((int)(0.5 * position.StaticEvaluation().Score), position.StaticEvaluation().Score);
        Assert.AreEqual((int)(0.75 * position.StaticEvaluation().Score), position.StaticEvaluation().Score);
    }
