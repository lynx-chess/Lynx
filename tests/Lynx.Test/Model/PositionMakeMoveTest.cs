...
public class PositionMakeMoveTest
{
    ...
    public void CastlingRemovesCastlingRights_Short_White()
    {
        ...
        Assert.AreNotEqual(default(int), position.Castle & CastlingRights.WK);
        Assert.AreNotEqual(default(int), position.Castle & CastlingRights.WQ);
        Assert.AreNotEqual(default(int), position.Castle & CastlingRights.BK);
        Assert.AreNotEqual(default(int), position.Castle & CastlingRights.BQ);
        ...
        Assert.AreEqual(default(int), newPosition.Castle & CastlingRights.WK);
        Assert.AreEqual(default(int), newPosition.Castle & CastlingRights.WQ);
        Assert.AreNotEqual(default(int), newPosition.Castle & CastlingRights.BK);
        Assert.AreNotEqual(default(int), newPosition.Castle & CastlingRights.BQ);
    }
    ...
    public void CastlingRemovesCastlingRights_Short_Black()
    {
        ...
        // Assert - Castling rights
        Assert.AreEqual(default(int), newPosition.Castle & CastlingRights.BK);
        Assert.AreEqual(default(int), newPosition.Castle & CastlingRights.BQ);
        Assert.AreNotEqual(default(int), newPosition.Castle & CastlingRights.WK);
        Assert.AreNotEqual(default(int), newPosition.Castle & CastlingRights.WQ);
    }
