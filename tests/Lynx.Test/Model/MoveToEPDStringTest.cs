...
//        {
//            move = MoveExtensions.EncodeCastle(sourceSquare, targetSquare);
//        }
...
//            {
//                move = MoveExtensions.EncodeEnPassant(sourceSquare, targetSquare);
//            }
//            else if (isDoublePawnPush != default)
//            {
//                move = MoveExtensions.Encode(sourceSquare, targetSquare);
//            }
//            else if (promotedPiece != default)
//            {
//                if (isCapture != default)
//                {
//                    move = MoveExtensions.EncodePromotion(sourceSquare, targetSquare, promotedPiece);
//                }
//                else
//                {
//                    move = MoveExtensions.EncodePromotion(sourceSquare, targetSquare, promotedPiece);
