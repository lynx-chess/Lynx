...
public class GeneratePawnMovesTest
{
    ...
    [TestCase("1k6/8/1K6/8/8/p1p1p1p1/P1P1P1P1/8 w - - 0 1", 0)]
    [TestCase("1k6/8/1K6/8/8/R1R1R1R1/P1P1P1P1/8 w - - 0 1", 0)]
    [TestCase("1k6/8/1K6/8/p1p1p1p1/8/P1P1P1P1/8 w - - 0 1", 4)]
    [TestCase("8/8/8/8/R1R1R1R1/8/P1P1P1P1/K1k5 w - - 0 1", 4)]
    [TestCase("k1K5/p1p1p1p1/P1P1P1P1/8/8/8/8/8 b - - 0 1", 0)]
    [TestCase("8/p1p1p1p1/r1r1r1r1/8/8/1k6/8/1K6 b - - 0 1", 0)]
    [TestCase("8/p1p1p1p1/8/P1P1P1P1/8/1k6/8/1K6 b - - 0 1", 4)]
    [TestCase("8/p1p1p1p1/8/r1r1r1r1/8/1k6/8/1K6 b - - 0 1", 4)]
    ...
    {
        var position = new Position("7k/8/8/8/8/1n6/PPP5/7K w - - 0 1");
        ...
        position = new Position("7k/ppp5/1N6/8/8/8/8/7K b - - 0 1");
    ...
    {
        var position = new Position("3k4/P6P/8/8/8/8/p6p/3K4 w - - 0 1");
        ...
        position = new Position("3k4/P6P/8/8/8/8/p6p/3K4 b - - 0 1");
    ...
    {
        var position = new Position("BqBk1BqB/P6P/8/8/8/8/p6p/bQbK1bQb w - - 0 1");
        var offset = Utils.PieceOffset(position.Side);
        var whiteMoves = GeneratePawnMoves(position).ToList();
        ...
        position = new Position("BqBk1BqB/P6P/8/8/8/8/p6p/bQbK1bQb b - - 0 1");
        offset = Utils.PieceOffset(position.Side);
        var blackMoves = GeneratePawnMoves(position).ToList();
...
#if DEBUG
    [TestCase("PPPPPPPP/8/8/8/8/8/8/2k1K3 w - - 0 1", Description = "Last rank")]
    [TestCase("2K1k3/8/8/8/8/8/8/pppppppp b - - 0 1", Description = "Last rank")]
#endif
    [TestCase("8/8/8/8/p1p1p1p1/PpPpPpPp/1P1P1P1P/K1k5 w - - 0 1", Description = "Blocked position")]
    [TestCase("k1K5/p1p1p1p1/PpPpPpPp/1P1P1P1P/8/8/8/8 b - - 0 1", Description = "Blocked position")]
    [TestCase("7k/8/8/N7/P7/1p6/8/7K w - - 0 1", Description = "Backwards/inverse capture")]
    [TestCase("7k/8/8/1P6/p7/n7/8/7K b - - 0 1", Description = "Backwards/inverse capture")]
