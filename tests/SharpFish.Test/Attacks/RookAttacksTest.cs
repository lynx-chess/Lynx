...
namespace SharpFish.Test.Attacks
{
    public class RookAttacksTest
    {
        ...
        public void GenerateRookAttacksOnTheFly(BS bishopSquare, BS[] occupiedSquares, BS[] attackedSquares)
        {
            var occupiedBoard = new BitBoard(occupiedSquares);

            var attacks = AttacksGenerator.GenerateRookAttacksOnTheFly((int)bishopSquare, occupiedBoard);
