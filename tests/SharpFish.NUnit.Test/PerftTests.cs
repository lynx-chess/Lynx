/*
 *  Issue with Explicit and Categories: https://github.com/nunit/nunit/issues/3846
 *  Whenever it's resolved, Explicit should be added to the ones with Category = "LongRunning", and replace Category = "ExtraLongRunning"
 *
 */
...
namespace SharpFish.Test
{
    ...
    public class PerftTests
    {
        ...
        [TestCase(Constants.InitialPositionFEN, 6, 119_060_324, Category = "ExtraLongRunning")]
        [TestCase(Constants.InitialPositionFEN, 7, 3_195_901_860, Category = "ExtraLongRunning")]
        [TestCase(Constants.InitialPositionFEN, 8, 84_998_978_956, Category = "ExtraLongRunning")]
        [TestCase(Constants.InitialPositionFEN, 9, 2_439_530_234_167, Category = "ExtraLongRunning")]
        ...
        [TestCase("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", 5, 193_690_690, Category = "LongRunning")]
        [TestCase("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", 6, 8_031_647_685, Category = "ExtraLongRunning")]
        ...
        [TestCase("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 7, 178_633_661, Category = "LongRunning")]
        [TestCase("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 8, 3_009_794_393, Category = "ExtraLongRunning")]
        ...
        [TestCase("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1", 5, 15_833_292, Category = "LongRunning")]
        [TestCase("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1", 6, 706_045_033, Category = "ExtraLongRunning")]
        ...
        [TestCase("r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1", 5, 15_833_292, Category = "LongRunning")]
        [TestCase("r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1", 6, 706_045_033, Category = "ExtraLongRunning")]
        ...
        [TestCase("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 5, 89_941_194, Category = "LongRunning")]
        ...
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 5, 164_075_551, Category = "LongRunning")]
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 6, 6_923_051_137, Category = "ExtraLongRunning")]
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 7, 287_188_994_746, Category = "ExtraLongRunning")]
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 8, 11_923_589_843_526, Category = "ExtraLongRunning")]
        [TestCase("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 9, 490_154_852_788_714, Category = "ExtraLongRunning")]
