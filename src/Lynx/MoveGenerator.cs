...
public static class MoveGenerator
{
    ...
    internal static void GenerateCastlingMoves(ref int localIndex, Span<Move> movePool, Position position)
    {
        if (position.Castle != default)
        {
            ...
            {
                bool ise1Attacked = position.IsSquareAttacked(Constants.WhiteKingSourceSquare, (int)Side.Black);
            ...
            {
                bool ise8Attacked = position.IsSquareAttacked(Constants.BlackKingSourceSquare, (int)Side.White);
