...
public sealed class OptionCommand : EngineBaseCommand
{
    ...
    [
        ...
        $"option name {nameof(Configuration.EngineSettings.SEE_BadCaptureBaseReduction)} type spin default {Configuration.EngineSettings.SEE_BadCaptureDepthDivisor} min 0 max 1024",
