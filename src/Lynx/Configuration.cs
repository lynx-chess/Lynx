...
public sealed class EngineSettings
{
    ...
    public TaperedEvaluationTerm IsolatedPawnPenalty { get; set; } = new(-19, -15);

    public TaperedEvaluationTerm OpenFileRookBonus { get; set; } = new(45, 5);

    public TaperedEvaluationTerm SemiOpenFileRookBonus { get; set; } = new(15, 6);

    public TaperedEvaluationTerm QueenMobilityBonus { get; set; } = new(2, 11);

    public TaperedEvaluationTerm SemiOpenFileKingPenalty { get; set; } = new(-28, 8);

    public TaperedEvaluationTerm OpenFileKingPenalty { get; set; } = new(-93, 4);

    public TaperedEvaluationTerm KingShieldBonus { get; set; } = new(11, -3);

    public TaperedEvaluationTerm BishopPairBonus { get; set; } = new(33, 79);

    public TaperedEvaluationTerm PieceProtectedByPawnBonus { get; set; } = new(7, 10);

    public TaperedEvaluationTerm PieceAttackedByPawnPenalty { get; set; } = new(-45, -22);
