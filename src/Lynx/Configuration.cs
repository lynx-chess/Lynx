...
public sealed class EngineSettings
{
    ...
    public double LMR_Base { get; set; } = 0.61;

    [SPSA<double>(1, 5, 0.1)]
    public double LMR_Divisor { get; set; } = 3.08;
    ...
    [SPSA<int>(1, 300, 15)]
    public int RFP_DepthScalingFactor { get; set; } = 31;

    //[SPSA<int>(1, 10, 0.5)]
    public int Razoring_MaxDepth { get; set; } = 2;

    [SPSA<int>(1, 300, 15)]
    public int Razoring_Depth1Bonus { get; set; } = 110;

    [SPSA<int>(1, 300, 15)]
    public int Razoring_NotDepth1Bonus { get; set; } = 227;
    ...
    [SPSA<int>(0, 200, 10)]
    public int History_BestScoreBetaMargin { get; set; } = 55;
    ...
    [SPSA<int>(1, 200, 10)]
    public int FP_DepthScalingFactor { get; set; } = 96;

    [SPSA<int>(0, 500, 25)]
    public int FP_Margin { get; set; } = 126;

    //[SPSA<int>(0, 10, 0.5)]
    public int HistoryPrunning_MaxDepth { get; set; } = 5;

    [SPSA<int>(-8192, 0, 512)]
    public int HistoryPrunning_Margin { get; set; } = -1711;
