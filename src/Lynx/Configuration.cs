...
public sealed class EngineSettings
{
    ...
    public double LMR_Base_Quiet { get; set; } = 0.43;

    [SPSA<double>(0.1, 2, 0.2)]
    public double LMR_Base_Noisy { get; set; } = 0.44;

    [SPSA<double>(1, 5, 0.2)]
    public double LMR_Divisor_Quiet { get; set; } = 2.76;

    [SPSA<double>(1, 5, 0.2)]
    public double LMR_Divisor_Noisy { get; set; } = 2.63;
    ...
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_Cutnode { get; set; } = 45;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_TTPV { get; set; } = 55;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_TTCapture { get; set; } = 121;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_PVNode { get; set; } = 34;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_InCheck { get; set; } = 133;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_Quiet { get; set; } = 63;

    /// <summary>
    /// Tuned from ~<see cref="History_MaxMoveValue"/> / 2
    /// </summary>
    [SPSA<int>(1, 8192, 512)]
    public int LMR_History_Divisor_Quiet { get; set; } = 2641;

    /// <summary>
    /// Tuned from ~<see cref="History_MaxMoveValue"/> / 2 * (3 / 4)
    /// </summary>
    [SPSA<int>(1, 8192, 512)]
    public int LMR_History_Divisor_Noisy { get; set; } = 5724;

    [SPSA<int>(20, 100, 8)]
    public int LMR_DeeperBase { get; set; } = 25;
...
#pragma warning restore CA1805 // Do not initialize unnecessarily
    ...
    [SPSA<int>(50, 350, 15)]
    public int NMP_StaticEvalBetaDivisor { get; set; } = 94;
    ...
    [SPSA<double>(1, 3, 0.1)]
    public double AspirationWindow_Multiplier { get; set; } = 1.31;
    ...
    [SPSA<int>(10, 150, 10)]
    public int ImprovingRate { get; set; } = 55;
    ...
    [SPSA<int>(50, 150, 10)]
    public int RFP_NotImproving_Margin { get; set; } = 98;
    ...
    [SPSA<int>(1, 300, 15)]
    public int Razoring_Depth1Bonus { get; set; } = 98;

    [SPSA<int>(1, 300, 15)]
    public int Razoring_NotDepth1Bonus { get; set; } = 203;
    ...
    public int History_Bonus_MaxIncrement { get; set; } = 1799;

    [SPSA<int>(1, 500, 35)]
    public int History_Bonus_Constant { get; set; } = 205;

    [SPSA<int>(1, 500, 35)]
    public int History_Bonus_Linear { get; set; } = 112;

    [SPSA<double>(1, 10, 0.5)]
    public double History_Bonus_Quadratic { get; set; } = 5.66;

    [SPSA<int>(512, 4096, 250)]
    public int History_Malus_MaxDecrement { get; set; } = 1_895;

    [SPSA<int>(1, 500, 35)]
    public int History_Malus_Constant { get; set; } = 160;
    ...
    [SPSA<int>(0, 200, 10)]
    public int History_BestScoreBetaMargin { get; set; } = 137;
    ...
    [SPSA<int>(1, 200, 10)]
    public int FP_DepthScalingFactor { get; set; } = 89;

    [SPSA<int>(0, 500, 25)]
    public int FP_Margin { get; set; } = 77;

    [SPSA<int>(enabled: false)]
    public int HistoryPrunning_MaxDepth { get; set; } = 5;

    [SPSA<int>(-8192, 0, 512)]
    public int HistoryPrunning_Margin { get; set; } = 0;
...
#pragma warning restore CA1805 // Do not initialize unnecessarily
    ...
    [SPSA<int>(-150, -50, 10)]
    public int PVS_SEE_Threshold_Noisy { get; set; } = -90;
    ...
    /// </summary>
    [SPSA<int>(25, 200, 15)]
    public int CorrHistoryWeight_Pawn { get; set; } = 158;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.CorrHistScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 200, 15)]
    public int CorrHistoryWeight_NonPawnSTM { get; set; } = 58;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.CorrHistScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 200, 15)]
    public int CorrHistoryWeight_NonPawnNoSTM { get; set; } = 120;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.CorrHistScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 200, 15)]
    public int CorrHistoryWeight_Minor { get; set; } = 139;
    ...
    [SPSA<int>(0, 50, 5)]
    public int SE_DoubleExtensions_Margin { get; set; } = 13;
