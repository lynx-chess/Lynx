...
public sealed class EngineSettings
{
    ...
    public TaperedEvaluationTerm IsolatedPawnPenalty = new(-19, -15);

    public TaperedEvaluationTerm OpenFileRookBonus = new(45, 6);

    public TaperedEvaluationTerm SemiOpenFileRookBonus = new(15, 10);

    public TaperedEvaluationTerm QueenMobilityBonus = new(-0, 17);

    public TaperedEvaluationTerm SemiOpenFileKingPenalty = new(-23, 5);

    public TaperedEvaluationTerm OpenFileKingPenalty = new(-86, 1);

    public TaperedEvaluationTerm KingShieldBonus = new(8, -4);

    public TaperedEvaluationTerm BishopPairBonus = new(32, 80);

    public TaperedEvaluationTerm PieceProtectedByPawnBonus = new(10, 11);

    public TaperedEvaluationTerm PieceAttackedByPawnPenalty = new(-45, -23);
