...
public sealed class EngineSettings
{
    ...
    public double LMR_Base_Quiet { get; set; } = 0.49;

    [SPSA<double>(0.1, 2, 0.2)]
    public double LMR_Base_Noisy { get; set; } = 0.43;

    [SPSA<double>(1, 5, 0.2)]
    public double LMR_Divisor_Quiet { get; set; } = 3.17;
    ...
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_Improving { get; set; } = 141;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_Cutnode { get; set; } = 43;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_TTPV { get; set; } = 148;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_TTCapture { get; set; } = 87;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_PVNode { get; set; } = 123;
    ...
    /// </summary>
    [SPSA<int>(25, 300, 30)]
    public int LMR_Quiet { get; set; } = 71;

    /// <summary>
    /// Tuned from ~<see cref="History_MaxMoveValue"/> / 2
    /// </summary>
    [SPSA<int>(1, 8192, 512)]
    public int LMR_History_Divisor_Quiet { get; set; } = 2572;

    /// <summary>
    /// Tuned from ~<see cref="History_MaxMoveValue"/> / 2 * (3 / 4)
    /// </summary>
    [SPSA<int>(1, 8192, 512)]
    public int LMR_History_Divisor_Noisy { get; set; } = 3974;

    [SPSA<int>(20, 100, 8)]
    public int LMR_DeeperBase { get; set; } = 54;
...
#pragma warning restore CA1805 // Do not initialize unnecessarily
    ...
    [SPSA<int>(50, 350, 15)]
    public int NMP_StaticEvalBetaDivisor { get; set; } = 105;

    //[SPSA<int>(1, 10, 0.5)]
    public int NMP_StaticEvalBetaMaxReduction { get; set; } = 3;

    [SPSA<int>(5, 30, 1)]
    public int AspirationWindow_Base { get; set; } = 8;
    ...
    [SPSA<int>(1, 300, 15)]
    public int Razoring_Depth1Bonus { get; set; } = 36;

    [SPSA<int>(1, 300, 15)]
    public int Razoring_NotDepth1Bonus { get; set; } = 248;
    ...
    [SPSA<int>(0, 200, 10)]
    public int History_BestScoreBetaMargin { get; set; } = 120;
    ...
    [SPSA<int>(1, 200, 10)]
    public int FP_DepthScalingFactor { get; set; } = 82;

    [SPSA<int>(0, 500, 25)]
    public int FP_Margin { get; set; } = 54;

    //[SPSA<int>(0, 10, 0.5)]
    public int HistoryPrunning_MaxDepth { get; set; } = 5;

    [SPSA<int>(-8192, 0, 512)]
    public int HistoryPrunning_Margin { get; set; } = -24;
...
#pragma warning restore CA1805 // Do not initialize unnecessarily
    ...
    [SPSA<int>(-100, -10, 10)]
    public int PVS_SEE_Threshold_Quiet { get; set; } = -43;

    [SPSA<int>(-150, -50, 10)]
    public int PVS_SEE_Threshold_Noisy { get; set; } = -94;
    ...
    /// </summary>
    [SPSA<int>(25, 200, 15)]
    public int CorrHistoryWeight_NonPawnSTM { get; set; } = 80;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.CorrHistScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 200, 15)]
    public int CorrHistoryWeight_NonPawnNoSTM { get; set; } = 110;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.CorrHistScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 200, 15)]
    public int CorrHistoryWeight_Minor { get; set; } = 140;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.CorrHistScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 200, 15)]
    public int CorrHistoryWeight_Major { get; set; } = 75;
