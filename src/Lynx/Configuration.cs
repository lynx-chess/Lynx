...
public sealed class EngineSettings
{
    ...
    public double LMR_Base_Quiet { get; set; } = 1.15;

    [SPSA<double>(0.1, 2, 0.1)]
    public double LMR_Base_Noisy { get; set; } = 0.66;

    [SPSA<double>(1, 5, 0.1)]
    public double LMR_Divisor_Quiet { get; set; } = 2.75;
    ...
    /// </summary>
    [SPSA<int>(25, 300, 10)]
    public int LMR_Improving { get; set; } = 120;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 10)]
    public int LMR_Cutnode { get; set; } = 105;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 10)]
    public int LMR_TTPV { get; set; } = 95;

    /// <summary>
    /// Needs to be re-scaled dividing by <see cref="EvaluationConstants.LMRScaleFactor"/>
    /// </summary>
    [SPSA<int>(25, 300, 10)]
    public int LMR_PVNode { get; set; } = 106;
    ...
    /// </summary>
    [SPSA<int>(1, 8192, 128)]
    public int LMR_History_Divisor_Quiet { get; set; } = 3544;

    /// <summary>
    /// Tuned from ~<see cref="History_MaxMoveValue"/> / 2 * (3 / 4)
    /// </summary>
    [SPSA<int>(1, 8192, 128)]
    public int LMR_History_Divisor_Noisy { get; set; } = 3076;
