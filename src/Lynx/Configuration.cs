...
public sealed class EngineSettings
{
    ...
    public TaperedEvaluationTerm SemiOpenFileRookBonus { get; set; } = new(16, 9);

    public TaperedEvaluationTerm QueenMobilityBonus { get; set; } = new(2, 9);

    public TaperedEvaluationTerm SemiOpenFileKingPenalty { get; set; } = new(-17, 14);

    public TaperedEvaluationTerm OpenFileKingPenalty { get; set; } = new(-79, 10);

    public TaperedEvaluationTerm KingShieldBonus { get; set; } = new(19, -14);

    public TaperedEvaluationTerm BishopPairBonus { get; set; } = new(32, 80);

    public TaperedEvaluationTerm PieceProtectedByPawnBonus { get; set; } = new(10, 12);

    public TaperedEvaluationTerm PieceAttackedByPawnPenalty { get; set; } = new(-44, -24);
