...
#pragma warning restore IDE0055
    ...
    [         //     P      N      B      R       Q  K     p      n      b      r       q       k
        /* P */ [    0,     0,     0,     0,      0, 0,  15000, 40000, 45000, 55000, 115000], // 0],
        /* N */ [    0,     0,     0,     0,      0, 0,  14000, 39000, 44000, 54000, 114000], // 0],
        /* B */ [    0,     0,     0,     0,      0, 0,  13000, 38000, 43000, 53000, 113000], // 0],
        /* R */ [    0,     0,     0,     0,      0, 0,  12000, 37000, 42000, 52000, 112000], // 0],
        /* Q */ [    0,     0,     0,     0,      0, 0,  11000, 36000, 41000, 51000, 111000], // 0],
        /* K */ [    0,     0,     0,     0,      0, 0,  10000, 35000, 40001, 50000, 110000], // 0],
        /* p */ [15000, 40000, 45000, 55000, 115000, 0,     0,    0,    0,    0,         0 ], // 0],
        /* n */ [14000, 39000, 44000, 54000, 114000, 0,     0,    0,    0,    0,         0 ], // 0],
        /* b */ [13000, 38000, 43000, 53000, 113000, 0,     0,    0,    0,    0,         0 ], // 0],
        /* r */ [12000, 37000, 42000, 52000, 112000, 0,     0,    0,    0,    0,         0 ], // 0],
        /* q */ [11000, 36000, 41000, 51000, 111000, 0,     0,    0,    0,    0,         0 ], // 0],
        /* k */ [10000, 35000, 40001, 50000, 110000, 0,     0,    0,    0,    0,         0 ], // 0]
    ];
