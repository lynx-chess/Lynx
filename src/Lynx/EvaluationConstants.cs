...
#pragma warning restore IDE0055
    ...
    [         //      P       N       B       R          Q       K     p       n       b       r       q         k
        /* P */ [     0,      0,      0,      0,         0,      0, 110000, 110100, 110200, 110300, 110400  ], // 0],
        /* N */ [     0,      0,      0,      0,         0,      0,  50000,  50100,  50200,  50300,  50400  ], // 0],
        /* B */ [     0,      0,      0,      0,         0,      0,  35000,  35100,  35200,  35300,  35400  ], // 0],
        /* R */ [     0,      0,      0,      0,         0,      0,  30000,  30100,  30200,  30300,  30400  ], // 0],
        /* Q */ [     0,      0,      0,      0,         0,      0,  20000,  20100,  20200,  20300,  20400  ], // 0],
        /* K */ [     0,      0,      0,      0,         0,      0,  10000,  10100,  10200,  10300,  10400  ], // 0],
        /* p */ [110000, 110100, 110200, 110300, 110400, 0,      0,      0,      0,      0,       0 ], // 0],
        /* n */ [ 50000,  50100,  50200,  50300,  50400, 0,      0,      0,      0,      0,       0 ], // 0],
        /* b */ [ 35000,  35100,  35200,  35300,  35400, 0,      0,      0,      0,      0,       0 ], // 0],
        /* r */ [ 30000,  30100,  30200,  30300,  30400, 0,      0,      0,      0,      0,       0 ], // 0],
        /* q */ [ 20000,  20100,  20200,  20300,  20400, 0,      0,      0,      0,      0,       0 ], // 0],
        /* k */ [ 10000,  10100,  10200,  10300,  10400, 0,      0,      0,      0,      0,       0 ], // 0]
    ];
