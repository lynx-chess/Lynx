...
#pragma warning restore S3949 // Calculations should not overflow
            ...
            {
                var nmpReduction = Configuration.EngineSettings.NMP_BaseDepthReduction + ((depth + Configuration.EngineSettings.NMP_DepthIncrement + (improving ? 1 : 0)) / Configuration.EngineSettings.NMP_DepthDivisor);   // Clarity
