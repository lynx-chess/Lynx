...
#pragma warning restore S3949 // Calculations should not overflow
            ...
            else if (ttElementType == default)
            {
                // Internal Iterative Deepening (IID)
                // Search with reduced depth to fill TT and history and get a best move candidate
                _ = -NegaMax(depth - 2, ply + 1, -beta, -alpha);
                ttBestMove = (ShortMove)_pVTable[pvIndex];
            }
        }
