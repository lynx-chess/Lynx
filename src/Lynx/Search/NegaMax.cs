            ...
            else
            {
                ...
                if (isNotGettingCheckmated)
                {
                                ...
                                : Configuration.EngineSettings.LMR_MinFullDepthSearchedMoves_NonPV))
                    {
                        ...
                        if (isCapture)
                        {
                            reduction -= _captureHistory[CaptureHistoryIndex(move.Piece(), move.TargetSquare(), move.CapturedPiece())] / Configuration.EngineSettings.History_NoisyLMRDivisor;
                        }
                        else
                        {
                            if (pvNode)
                            ...
                            reduction -= _quietHistory[move.Piece()][move.TargetSquare()] / Configuration.EngineSettings.History_QuietLMRDivisor;
                        }
