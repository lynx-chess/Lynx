...
static void TranspositionTable()
{
    ...
    transpositionTable.RecordHash(mask, position, depth: 5, ply: 3, rawScore: +19, nodeType: NodeType.Alpha, move: 1234);
    var entry = transpositionTable.ProbeHash(mask, position, depth: 5, ply: 3, alpha: 20, beta: 30);
    Console.WriteLine(entry); // Expected 20

    transpositionTable.RecordHash(mask, position, depth: 5, ply: 3, rawScore: +21, nodeType: NodeType.Alpha, move: 1234);
    ...
    transpositionTable.RecordHash(mask, position, depth: 5, ply: 3, rawScore: +29, nodeType: NodeType.Beta, move: 1234);
    entry = transpositionTable.ProbeHash(mask, position, depth: 5, ply: 3, alpha: 20, beta: 30);
    Console.WriteLine(entry); // Expected 12_345_678

    transpositionTable.RecordHash(mask, position, depth: 5, ply: 3, rawScore: +31, nodeType: NodeType.Beta, move: 1234);
    entry = transpositionTable.ProbeHash(mask, position, depth: 5, ply: 3, alpha: 20, beta: 30);
