...
public class Move_UCIString_Benchmark : BaseBenchmark
{
    ...
    [
        MoveExtensions.EncodeShortCastle(Constants.InitialWhiteKingSquare, Constants.WhiteShortCastleKingSquare, (int)Piece.K),
        MoveExtensions.EncodeLongCastle(Constants.InitialBlackKingSquare, Constants.BlackLongCastleKingSquare, (int)Piece.k),
